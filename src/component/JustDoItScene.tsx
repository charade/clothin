...
// import { OrbitControls, Text,SpotLight } from '@react-three/drei';
...
//             textRef.current.position.lerp(vecPosition, 0.02);
//             if(textRef.current.rotation.z < Math.PI/2)
//             textRef.current.rotation.z += 0.007 //THREE.MathUtils.lerp(Math.PI/2,0, 1);
//         }
//     })
